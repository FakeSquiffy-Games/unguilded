...
func init_projectile(p_pos: Vector2, p_dir: Vector2, p_speed: float, p_piercing: bool, p_skill: SkillCommand, p_stats: StatBlock) -> void:
	...
	lifetime_timer = 5.0 # Max 5 seconds alive as a strict failsafe
